...
Launch the Client App: Open the app on your device.

Detect Drone: The app searches for a specific drone ID (D8:3A:DD:E2:55:36) via Bluetooth LE.

Acquire GPS: The app acquires GPS location data.

Capture Photo: Tap the shutter button at the bottom of the screen.

Performance Evaluation: The app generates hashes 30 times across multiple durations and measures the average processing time.

Performance Report: Results are displayed in a dialog.

Navigate to Verification Screen: Tap "Proceed".

Select Proof Duration: Select the hash duration to submit to the server.

Submit to Server: Tap the "Submit to Server" button.

Record on Blockchain: Once ZKP generation is complete, tap "Record on Blockchain" to record the proof on Ethereum Sepolia.

Verify Transaction: Verify the transaction hash on Etherscan.
...
<img src="assets/safe.jpg" width="200" alt="Safe environment screen">

<img src="assets/photo.jpg" width="200" alt="Photo capture screen">

<img src="assets/send.jpg" width="200" alt="Data submission screen">
